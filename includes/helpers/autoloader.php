...
function autoloader( $resource = '' ) {
	$resource_path  = false;
	$namespace_root = 'WPADVANCEDTHEME\\';
	...
	if ( 'includes' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/includes/%s/%s.php', untrailingslashit( WPADVANCEDTHEME_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\WPADVANCEDTHEME\Includes\Helpers\autoloader' );